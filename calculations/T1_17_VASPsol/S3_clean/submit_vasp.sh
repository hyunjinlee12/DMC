...
# Usage: sbatch -J <jobname> --chdir=<calcdir> submit_vasp.sh
...
# VASPsol build required (LSOL/EB_K/TAU). If the standard vasp.6.4.3 build
# was compiled with VASPsol source, this same path works. If not, point
# VASP_BIN at a solvation-enabled build.
